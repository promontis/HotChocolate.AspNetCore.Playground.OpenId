...
namespace HotChocolate.AspNetCore.Playground
{
    public class PlaygroundOptions
    {
        ...
        private PathString _callbackPath = new PathString("/callback");

        public PlaygroundOptions(OpenIdConfiguration openIdConfiguration)
        {
            _path = _defaultPath = new PathString("/playground");
            OpenIdConfiguration = openIdConfiguration;
        }

        public OpenIdConfiguration OpenIdConfiguration { get; }
